...
const socials =[
  { Icon : FaXTwitter, label : "X" , href : "https://twitter.com/girishsoodi" },
  { Icon : FaLinkedinIn, label : "LinkedIn" , href : "http://www.linkedin.com/in/girish-soodi-310b1b311 " },
  { Icon : FaGithub, label : "GitHub" , href : "https://github.com/girishsoodi" }
]
...
const roles = useMemo(()=>["web Developer", "AI-ML Enthusiast", "Software Developer"], [])
    ...
    id="home" className="w-full h-screen relative bg-black overflow-hidden">
      ...
      transition={{ duration: 0.6 }}>
        <span>
          ...
          <span className="inline-block w-[2px] ml-1 bg-white animate-pulse allign-middle"
          ...
          transition={{ duration: 1,}}>
            ...
            <span className="text-white font-bold text-5xl sm:text-6xl md:text-7xl lg:text-8xl lg:whitespace-nowrap">
              ...
              <motion.p className="mt-6 text-base sm:text-lg md:text-xl text-grey-300 max-w-2xl mx-auto lg:mx-0"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4 , duration: 0.8}}>
                I am a passionate developer with expertise in creating dynamic and responsive web applications. 
                I love to explore new technologies and continuously enhance my skills to deliver innovative solutions.

              </motion.p>
              <motion.div className="mt-10 flex flex-wrap justify-center lg:justify-start gap-6 "
              initial={{ opacity: 0}}
              animate={{ opacity: 1}}
      ...
      <div className="relative hidden lg:block">
        ...
        className="absolute top-1/2 -translate-y-1/2 pointer-events-none"
         style={{
          right: "-30px", width: "min(22vw, 410px)" ,height : "min(40vw, 760px)", borderRadius : "50%",
          filter : "blur(38px)" , opacity: 0.32 ,
          background : "conic-gradient(from 0deg , #1cd8d2, #00bf8f, #302b63, #1cd8d2)"
        }}
        />
        <motion.img src={avator} alt="Girish Soodi"
